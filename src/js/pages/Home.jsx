      ...
      <div className="container px-4 px-lg-5">
        ...
        <div className="row gx-4 gx-lg-5 align-items-center my-5">
          ...
          <div className="col-lg-5">
            <h2 className="font-weight-light">Testimonio del mes</h2>
            <p>
              "El mundo de las redes me ha enseñado conceptos que desconocía
              sobre mi diabetes". - Aida Gámez.
            </p>
            <a
              target="_blank"
              className="btn btn-outline-primary"
              href="https://www.makingdiabeteseasier.com/es/consejos-sobre-diabetes/vivir-con-diabetes/conceptos-sobre-diabetes"
            >
              Leer más
            </a>
          </div>
        ...
        <div className="row gx-4 gx-lg-5">
          <div className="col-md-4 mb-5">
            <Destacado
              titulo={"Foro"}
              texto={
                "Haz preguntas, comparte experiencias y sugerencias. Un espacio para crear comunidad."
              }
              label={
                <Link
          ...
          <div className="col-md-4 mb-5">
            <Destacado
              titulo={"Te lo cambio. Te lo regalo."}
              texto={
                "Un espacio para que puedas intercambiar o regalar insumos. Lo que no necesitas, a alguien le puede servir."
              }
              label={
                <Link
                  style={{ textDecoration: "none", color: "white" }}
          ...
          <div className="col-md-4 mb-5">
            <Destacado
              ...
              texto={
                "Ingresa aquí para conocer a nuestros partners. Empresas que comercializan productos que seguro te van a interesar."
              }
              label={
                <Link
                  style={{ textDecoration: "none", color: "white" }}
...
>>>>>>> 13ce9eb64871354959dbd5ccce9edec7ea01483d
};
export default Home;
